...
filePath='/home/psanthal/impactProject/sentence_model/train_test_ali_18'
dirPath='/scratch/psanthal/impactProject/clustered_sentences'
modelPath='/scratch/psanthal/clustered-sent-ali-18/model-220.pth'
...
testDataset=multiViewDatasetConcat(dirPath,classes,filePath,nonManuals,False,False,shuffle=False)
...
multiViewDataLoader=DataLoader(testDataset,10,shuffle=False)
...
logger.info("The results for clustered four model for Ali with 8 frames sample: %s for sentence count: %s is:",220,18)
