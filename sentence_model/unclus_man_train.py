...
logger=createLogger('/scratch/psanthal','unclus-nonman-18')
logger.info("Training set total number of samples:%s",len(trainDataset))
saveDir='/scratch/psanthal/unclus-nonman-18/'
torch.manual_seed(1)
...
modelPath='/scratch/psanthal/unclus-nonman-18/model-40.pth'
...
for epoch in range(400):
	...
	if epoch%10==0 and epoch > 0:
		torch.save(net.state_dict(),saveDir+'model-'+str(epoch+40)+'.pth')
